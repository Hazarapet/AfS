...
def model(weights_path=None):
    ...
    conv27 = Conv2D(76, (3, 3), padding='same')(concat26)
    bn27 = BatchNormalization(axis=1)(conv27)
    act27 = Activation('relu')(bn27)

    concat27 = concatenate([concat26, act27], axis=1)

    conv28 = Conv2D(76, (3, 3), padding='same')(concat27)
    bn28 = BatchNormalization(axis=1)(conv28)
    act28 = Activation('relu')(bn28)

    concat28 = concatenate([concat27, act28], axis=1)

    conv29 = Conv2D(76, (3, 3), padding='same')(concat28)
    bn29 = BatchNormalization(axis=1)(conv29)
    act29 = Activation('relu')(bn29)

    concat29 = concatenate([concat28, act29], axis=1)

    conv210 = Conv2D(76, (3, 3), padding='same')(concat29)
    bn210 = BatchNormalization(axis=1)(conv210)
    act210 = Activation('relu')(bn210)

    concat210 = concatenate([concat29, act210], axis=1)

    conv211 = Conv2D(76, (3, 3), padding='same')(concat210)
    bn211 = BatchNormalization(axis=1)(conv211)
    act211 = Activation('relu')(bn211)

    concat211 = concatenate([concat210, act211], axis=1)

    conv212 = Conv2D(76, (3, 3), padding='same')(concat211)
    bn212 = BatchNormalization(axis=1)(conv212)
    act212 = Activation('relu')(bn212)

    # -----------------------------------------------------
    # --------------------- Bridge 2 ----------------------
    bridge_conv21 = Conv2D(128, (3, 3), padding='same')(act212)
    ...
    conv37 = Conv2D(88, (3, 3), padding='same')(concat36)
    bn37 = BatchNormalization(axis=1)(conv37)
    act37 = Activation('relu')(bn37)

    concat37 = concatenate([concat36, act37], axis=1)

    conv38 = Conv2D(88, (3, 3), padding='same')(concat37)
    bn38 = BatchNormalization(axis=1)(conv38)
    act38 = Activation('relu')(bn38)

    concat38 = concatenate([concat37, act38], axis=1)

    conv39 = Conv2D(88, (3, 3), padding='same')(concat38)
    bn39 = BatchNormalization(axis=1)(conv39)
    act39 = Activation('relu')(bn39)

    concat39 = concatenate([concat38, act39], axis=1)

    conv310 = Conv2D(88, (3, 3), padding='same')(concat39)
    bn310 = BatchNormalization(axis=1)(conv310)
    act310 = Activation('relu')(bn310)

    concat310 = concatenate([concat39, act310], axis=1)

    conv311 = Conv2D(88, (3, 3), padding='same')(concat310)
    bn311 = BatchNormalization(axis=1)(conv311)
    act311 = Activation('relu')(bn311)

    concat311 = concatenate([concat310, act311], axis=1)

    conv312 = Conv2D(88, (3, 3), padding='same')(concat311)
    bn312 = BatchNormalization(axis=1)(conv312)
    act312 = Activation('relu')(bn312)
